...
function SelectStyle({ onUserSelect }) {
  ...
  return (
    <div className='mt-7'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 gap-5 mt-3'>
        {styleOptions.map((item, index) => (
          <div key={index} className={`relative hover:scale-105 transition-all cursor-pointer rounded-xl
            ...
            <Image src={item.image} width={100} height={100} className='h-45 object-cover rounded-lg w-full' alt={item.name} />
